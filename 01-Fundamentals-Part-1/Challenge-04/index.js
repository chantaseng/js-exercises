...
// Steven needs a very simple tip calculator for
// whenever he goes to eat in a restaurant. In
// his country, it's usual to tip 15% if the bill value
// is between 50 and 300. If the value is different,
// the tip is 20%.

// Your Tasks:

// 1. Calculate the tip, depending on the bill
// value. Create a variable called tip for this.
// It's not allowed to use an if...else statement
// (if it's easier for you, you can start with
// an if...else statement, and then try to convert
...
// Note: Use the values of the bill and tip
// variables to construct this string. Don't
// hard-code them

// Test Data:

// Test with different bill
// values: 275, 40, and 430
