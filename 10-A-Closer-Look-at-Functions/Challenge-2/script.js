...
const poll1 = {
  question: 'Who is your favorite habs player?',
  options: [
    '0: Nick Suzuki',
    '1: Cole Caufield',
    '2: Kaiden Guhle',
...
// poll1.registerNewAnswer1();

document
  .querySelector('.poll')
  .addEventListener('click', poll1.registerNewAnswer1.bind(poll1));
*/
...
// header is in the backpack of the event function

// Just for fun, everytime i click the body it changes color
// (function () {
//   const header = document.querySelector('h1');
//   header.style.color = 'red';
//   document.querySelector('body').addEventListener('click', function () {
