...
const startLogOutTimer = function () {
  ...
  // set timer to 5 min
  let time = 120;
  // call the timer at every second
  tick();
...
/*
// Converting and testing if its a number
console.log(23 === 23.0);
...
// PARSING, 2nd argument is redux(Base of the numeral system)
...
console.log(Math.max(8, 10, 23, 4, 6));
console.log(Math.max(8, 10, '23', 4, 6));
console.log(Math.max(8, 10, '23px', 4, 6));

console.log(Math.min(8, 10, 23, 4, 6));
...
// floor better than trunc cuz it can work in all situation(positive or negative)
console.log(Math.trunc(-23.3));
console.log(Math.floor(-23.3));
...
console.log(5 % 2);
console.log(5 / 2); // 5 = 2 * 2 + 1 (remainder is 1)

console.log(8 % 3);
console.log(8 / 3); // 8 = 3 * 2 + 2 (remainder is 2)
...
console.log(diameter); // JS ignored the numeric separators (_)
