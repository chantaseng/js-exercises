...
document.querySelector('button').addEventListener('click', function () {
  ...
  for (const [i, r] of rows.entries()) {
    ...
    /*
    const rowSplit = r.toLowerCase().trim().split('_'); // ['underscore', 'case']
    const secondWord = rowSplit[1]; // case
    const capitalizationFirstLetter = secondWord[0].toUpperCase(); // C
    const concatenate =
      rowSplit[0] + capitalizationFirstLetter + secondWord.slice(1);
    console.log(concatenate);
    */

    // for (const r of rows) {
    //   const rowsLowerCase = r.toLowerCase().trim(); // underscore_case
    //   const splitWord = rowsLowerCase.split('_'); // [underscore, case]
    //   const separateWord = splitWord[1]; // case
    //   const capitalizationWord = separateWord[0].toUpperCase(); // C
    //   const concatenateWord =
    //     splitWord[0] + (capitalizationWord + separateWord.slice(1));
